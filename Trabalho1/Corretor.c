...
void testQ4()
{
    ...
    printf("%d\n", posicoes[5] == 54);
  ///////////////////////////////////////
    strcpy(strTexto, "Que o medo de falhar nunca supere a vontade de conseguir!");
    strcpy(strBusca, "de");
    printf("%d\n", q4(strTexto, strBusca, posicoes) == 3);
    printf("%d\n", posicoes[0] == 12);
    printf("%d\n", posicoes[1] == 13);
    ...
    printf("%d\n", posicoes[5] == 46);
    /////////////////////////////////////
    strcpy(strTexto, "A determinação de hoje é o sucesso de amanhã");
    strcpy(strBusca, "ão");
    printf("%d\n", q4(strTexto, strBusca, posicoes) == 1);
    printf("%d\n", posicoes[0] == 13);
    printf("%d\n", posicoes[1] == 14);

    strcpy(strTexto, "Levaremos um tempo para crescer, levaremos um tempo para amadurecer, levaremos um tempo para entender, levaremos um tempo para envelhecer, levaremos um tempo para morrer");
    strcpy(strBusca, "er");
    printf("%d\n", q4(strTexto, strBusca, posicoes) == 5);
    printf("%d\n", posicoes[0] == 30);
    printf("%d\n", posicoes[1] == 31);
    printf("%d\n", posicoes[2] == 66);
    printf("%d\n", posicoes[3] == 67);
